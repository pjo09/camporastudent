...
export const API = getEnv("VITE_API_URL") || (typeof window !== "undefined" && (window.location.hostname === "localhost" || window.location.hostname === "127.0.0.1") ? "http://localhost:5000/api" : "https://camporastudent.onrender.com/api");
