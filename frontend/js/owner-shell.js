...
function sidebarHTML(currentPage) {
  const navItems = [
    { href: "owner-dashboard.html", icon: "fa-house", label: "Dashboard", id: "dashboard" },
    { href: "owner-properties.html", icon: "fa-building", label: "My Properties", id: "properties" },
    { href: "add-property.html", icon: "fa-plus", label: "Add Property", id: "add-property" },
    { href: "owner-bookings.html", icon: "fa-calendar-check", label: "Bookings", id: "bookings" },
    { href: "owner-students.html", icon: "fa-user-graduate", label: "Students", id: "students" },
    { href: "owner-messages.html", icon: "fa-comments", label: "Messages", id: "messages" },
    { href: "owner-maintenance.html", icon: "fa-screwdriver-wrench", label: "Maintenance", id: "maintenance" },
    { href: "owner-payments.html", icon: "fa-indian-rupee-sign", label: "Payments", id: "payments" },
    { href: "owner-analytics.html", icon: "fa-chart-line", label: "Analytics", id: "analytics" },
    { href: "owner-reviews.html", icon: "fa-star", label: "Reviews", id: "reviews" },
    { href: "owner-notifications.html", icon: "fa-bell", label: "Notifications", id: "notifications" },
    { href: "owner-settings.html", icon: "fa-gear", label: "Settings", id: "settings" },
  ];

  const items = navItems.map((item) => {
    const active = item.href === currentPage || (currentPage === "add-property.html" && item.href === "add-property.html") ? "active" : "";
...
<aside class="v3-sidebar" id="sidebar">
  <div>
    <a href="owner-dashboard.html" class="v3-sidebar-logo">
      <img src="./images/logo.png" class="v3-logo-img" alt="Campora">
...
<div class="v3-profile-dropdown" id="profileDropdown" style="display:none">
  <a href="owner-settings.html" class="v3-dropdown-item"><i class="fa-solid fa-user"></i> Profile Settings</a>
  <a href="owner-dashboard.html" class="v3-dropdown-item"><i class="fa-solid fa-house"></i> Dashboard</a>
  <a href="owner-settings.html" class="v3-dropdown-item"><i class="fa-solid fa-gear"></i> Settings</a>
...
function setupShellListeners() {
  ...
  if (notifBell) {
    notifBell.addEventListener("click", () => {
      window.location.href = "owner-notifications.html";
    });
  }
}
