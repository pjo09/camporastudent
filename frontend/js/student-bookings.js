  ...
  list.innerHTML = filtered.map((b) => {
    ...
    return `
      <div class="sv3-list-item">
        <img src="${img}" alt="" style="width:56px;height:56px;border-radius:14px;object-fit:cover;flex-shrink:0" onerror="this.onerror=null; this.src='/assets/images/property-placeholder.jpg'">
