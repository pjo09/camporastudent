      ...
      <div class="sv3-card" style="padding:24px; border-radius:18px; display:flex; gap:20px; align-items:start; flex-wrap:wrap">
        ...
        <div style="flex:1; min-width:200px">
          ...
          <div style="display:flex; gap:10px; margin-top:18px; flex-wrap:wrap">
            <a href="/property-details.html?id=${encodeURIComponent(prop.id || prop._id)}" class="sv3-btn sv3-btn-primary" style="padding:8px 16px; font-size:13px"><i class="fa-solid fa-eye"></i> View Property</a>
